...
public class UserWithIdActionsCount {
  ...
  public static class TokenizerMapper
    ...
    public void map(Object key, Text value, Context context
      ...
      File file = new File("/Users/i338442/diplomna/tesst/src/main/resources/userIdPlusDateCount" + userId + ".txt");
      file.createNewFile();

      try(
          FileWriter fw = new FileWriter("/Users/i338442/diplomna/tesst/src/main/resources/userIdPlusDateCount" + userId + ".txt", true);
  ...
  public static void main(String[] args) throws Exception {
    ...
    FileOutputFormat.setOutputPath(job, new Path("/Users/i338442/diplomna/tesst/src/main/resources/outputUserIdsActionsCount" + userId));
  ...
  public static void execute(String[] args) throws IOException, ClassNotFoundException, InterruptedException {
    ...
    FileUtils.deleteDirectory(new File("/Users/i338442/diplomna/tesst/src/main/resources/outputUserIdsActionsCount" + userId));
    FileOutputFormat.setOutputPath(job, new Path("/Users/i338442/diplomna/tesst/src/main/resources/outputUserIdsActionsCount" + userId));
